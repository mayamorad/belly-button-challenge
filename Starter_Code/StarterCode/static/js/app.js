...
function demoInfo(sample)
{
    ...
    d3.json("samples.json").then((data) => {
        ...
        // filter based on the value of the sample (should returun 1 result in an array
...
// function that builts the bubble chart
function buiildBubbleChart(sample)
{
    //console.log(sample);
    //let data = d3.json("samples.json");
    //console.log(data);
